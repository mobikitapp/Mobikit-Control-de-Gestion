...
CREATE TABLE IF NOT EXISTS proyectos (
    ...
    estado VARCHAR(30) DEFAULT 'diseño' CHECK (estado IN ('diseño', 'proyecto_simple', 'en_desarrollo', 'aprobado_produccion', 'seccionado', 'enchapado', 'mecanizado', 'produccion_completa', 'embalando', 'listo_despacho', 'entregado', 'completado', 'cancelado')),
