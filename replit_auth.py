...
def require_role(*roles):
    ...
    def decorator(f):
        ...
        def decorated_function(*args, **kwargs):
            ...
            if current_user.rol.value not in [role.value if hasattr(role, 'value') else role for role in roles]:
                return render_template("403.html", message="No tiene permisos para acceder a esta página"), 403
