...
class StorageService:
    ...
    def _resolve_cliente_proyecto_ids(self, entity_type: str, entity_id: int) -> tuple[int, int]:
        """Resolve cliente_id and proyecto_id from entity"""
        from models import Contrato, Despacho, Proyecto
        ...
        elif entity_type == 'proyectos':
            proyecto = db.session.get(Proyecto, entity_id)
            if proyecto:
                return proyecto.cliente_id, proyecto.id
