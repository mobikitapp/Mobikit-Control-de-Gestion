    ...
    def calcular_capacidad_teorica(self, parametros=None):
        ...
        try:
            ...
            return {
                ...
                'oee_aplicado': oee,
                'utilizacion_efectiva': (horas_efectivas_mes / horas_nominales_mes) * 100 if horas_nominales_mes else 0,
                'capacidad_teorica': {
            ...
            return {
                ...
                'oee_aplicado': 0.70,
                'utilizacion_efectiva': 70.0,
                'capacidad_teorica': {'social': 205, 'estandar': 246, 'especial': 308},
                'tableros_por_hora': {'social': 1.67, 'estandar': 2.0, 'especial': 2.5}
            }
