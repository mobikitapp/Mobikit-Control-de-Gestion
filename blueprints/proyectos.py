...
def editar(proyecto_id):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            proyecto = proyectos_service.update_proyecto(proyecto_id, proyecto_data.dict(exclude_unset=True, exclude_none=True), current_user.id)
...
def cambiar_estado(proyecto_id):
    ...
    try:
        ...
        logger.error(f"Error changing estado for project {proyecto_id}: {str(e)}")
