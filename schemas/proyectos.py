...
class ProyectoSearchFilters(BaseModel):
    ...
    per_page: int = Field(default=10, ge=1, le=100, description="Elementos por página")
    ...
    estado_comercial: Optional[str] = Field(None, description="Filtrar por estado comercial")
