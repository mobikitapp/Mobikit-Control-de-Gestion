...
#!/usr/bin/env python3
"""
Script para otorgar acceso completo de proyectos al rol general
"""
...
def main():
    ...
    with app.app_context():
        try:
            ...
            # Actualizar permisos específicos para general en proyectos
            ...
            resultado_lectura = permisos_service.verificar_permiso_dinamico('general', 'proyectos', 'lectura')
            resultado_creacion = permisos_service.verificar_permiso_dinamico('general', 'proyectos', 'creacion') 
            resultado_edicion = permisos_service.verificar_permiso_dinamico('general', 'proyectos', 'edicion')
            resultado_eliminacion = permisos_service.verificar_permiso_dinamico('general', 'proyectos', 'eliminacion')
            
            print("\n" + "="*60)
            print("VERIFICACIÓN DE PERMISOS PARA ROL GENERAL EN PROYECTOS:")
            print("="*60)
            ...
            print(f"• Eliminación de proyectos: {'✓ SÍ' if resultado_eliminacion else '✗ NO'}")
            print("="*60)
            
            if resultado_lectura and resultado_creacion and resultado_edicion and resultado_eliminacion:
                print("🎉 ÉXITO: Rol general ahora tiene acceso completo a proyectos")
            else:
